...
# ---------------------- 全局参数配置（文件改为asphericity.txt） ----------------------
file_paths = [
    r"E:/uut 2/a40/a40/asphericity.txt",
    r"E:/uut 2/a40/a40p8/asphericity.txt",
    r"E:/uut 2/a40/a40p26/asphericity.txt"
]
...
plt.tight_layout()
# 输出文件名对应改为asphericity
plt.savefig(r"E:/uut 2/asphericity_block_error.png", bbox_inches="tight")
...
plt.xlabel('Block Size (ns)', fontsize=20)
# Y轴标签修改为对应非球度
plt.ylabel('Average Asphericity', fontsize=20)
plt.xlim(0, x_max_ns)
plt.ylim(bottom=0)
plt.legend(fontsize=18, frameon=False, ncol=3)
plt.grid(False)
...
plt.tight_layout()
# 输出文件名对应改为asphericity
plt.savefig(r"E:/uut 2/asphericity_block_avg_errorbar.png", bbox_inches="tight")